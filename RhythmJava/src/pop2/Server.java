...
//This is Server class which takes the data from database in local host and passes to the client class.
...
class ServiceThread extends Thread
{
    ...
    public void run()
    {
        try
        {
            ...
            // Vector message = new Vector(); // This a vector that takes multidimensional array for socket programming
            ...
            switch(a)
                    {
                        case "Register":
                            ...
                            try{
                                ...
                                //For conncetion
                                con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/Rhythm","root","");
		
                                 //For statement
                                String Query = "insert into Regiseterion (FirstName, LastName, email, CabinNum, UserName, UserPassword)"
                                + " values (?, ?, ?, ?, ?,?)";
...
public class Server {
    ...
    public static void main(String[] args) throws IOException{
        ServerSocket servSocket = new ServerSocket(3306);
        System.out.println("Server is initiated");
        
        while(true)
        {
            System.out.println("Waiting for client to port 3306");
